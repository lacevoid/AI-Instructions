...
This folder contains the **reusable AI instruction system** that complements your project's master specification. It defines universal engineering rules, workflows, and standards that apply to any project. Project-specific rules live separately in `12-project-specific/`.
...
| `03-architecture.md` | Layer architecture, Service Layer rules, dependency directions, context-based organization, routing, frontend org, abstraction philosophy, binding architectural decisions. |
| `04-coding-standards.md` | PHP & TypeScript/Vue style, comment policy, import ordering, formatting rules, file organization. |
...
| `07-security.md` | Auth, authz, validation, rate limiting, sensitive data, passwords, CSRF, key security rules. |
| `08-git.md` | Branching, commits, prohibited operations, commit message formats, project-specific branch naming. |
| `09-tools.md` | Terminal, paths, parallelism, linting, JS runtime, static analysis, tests, external tools. |
...
| `12-project-specific/` | Project-specific modules. Add files here for each project's unique invariants. |
