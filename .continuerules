...
8. Resolve conflict sesuai hierarki pada bagian 4.
9. Bekerja mengikuti workflow bagian 8.
10. Validasi terhadap quality gates dibagian 11.
...
> modul di `ai-instructions/` SEBELUM menulis kode apapun. Tidak ada pengecualian.
